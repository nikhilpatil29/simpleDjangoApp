...
cd /home/ec2-user/myApplication/project-venv/myApplication
...
python3 /home/ec2-user/myApplication/project-venv/myApplication/simpleDjangoApp/manage.py runserver 0.0.0.0:8080
